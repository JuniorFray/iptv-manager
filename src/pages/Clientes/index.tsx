...
export default function DashboardFinanceiro() {
  ...
  const labelStyle = { color: "rgba(255,255,255,0.5)", fontSize: "13px", fontWeight: "600", textTransform: "uppercase" as const, letterSpacing: "0.05em", marginBottom: "10px" };
  const valueStyle = (color: string) => ({ color: `rgb(${color})`, fontSize: "28px", fontWeight: "bold", margin: "0 0 4px 0" });
  const subStyle   = { color: "rgba(255,255,255,0.35)", fontSize: "12px" };

  return (
    <div>
      <div style={{ marginBottom: "28px" }}>
        <h1 style={{ color: "white", fontSize: "28px", fontWeight: "bold", margin: 0 }}>Dashboard Financeiro</h1>
        <p style={{ color: "rgba(255,255,255,0.5)", marginTop: "4px", fontSize: "14px" }}>
          Visão geral de receita e vencimentos
        </p>
      </div>
      ...
      <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
        ...
        <div className="glass-card" style={{ flex: 3, minWidth: "320px", overflow: "hidden" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {proxVencer.length === 0 ? (
                <tr><td colSpan={5} style={{ padding: "30px", textAlign: "center", color: "rgba(255,255,255,0.3)" }}>Nenhum cliente vencendo nesse período.</td></tr>
              ) : proxVencer
